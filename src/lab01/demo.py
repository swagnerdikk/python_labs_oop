...
run_validation_test("пассажиры в депо при создании", lambda: Bus(11, 40, 0, 5))
run_validation_test("ненулевая скорость в депо при создании", lambda: Bus(12, 40, 20, 0))

print_section("СЦЕНАРИЙ 3. СВОЙСТВА (GETTER/SETTER)")

b = Bus(5, 50)
b.start_route()
b.board_passengers(20)
...
bus_b.start_route()
bus_c.start_route()
bus_a.board_passengers(10)
bus_b.board_passengers(10)
bus_c.board_passengers(15)
